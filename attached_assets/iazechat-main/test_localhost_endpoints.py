#!/usr/bin/env python3
"""
Teste dos endpoints WhatsApp no localhost
"""

import requests
import json

# Configuration - usando localhost
BACKEND_URL = "http://localhost:8001/api"
ADMIN_EMAIL = "admin@admin.com"
ADMIN_PASSWORD = "102030@ab"

def test_localhost_endpoints():
    print("🔐 Fazendo login admin (localhost)...")
    ...
    # Resultado final
    print(f"\n📊 RESULTADO:")
    print(f"   - Refresh QR: {'✅ OK' if refresh_response.status_code == 200 else '❌ ERRO'}")
    print(f"   - Restart Session: {'✅ OK' if restart_response.status_code == 200 else '❌ ERRO'}")
